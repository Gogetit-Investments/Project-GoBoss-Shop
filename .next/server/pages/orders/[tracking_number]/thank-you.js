...
/* harmony import */ var _data_order__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(1932);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_layouts_general_layout__WEBPACK_IMPORTED_MODULE_5__, _data_client__WEBPACK_IMPORTED_MODULE_13__, _data_order__WEBPACK_IMPORTED_MODULE_14__]);
([_layouts_general_layout__WEBPACK_IMPORTED_MODULE_5__, _data_client__WEBPACK_IMPORTED_MODULE_13__, _data_order__WEBPACK_IMPORTED_MODULE_14__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const ThankYou = ()=>{
    ...
    const { createOrderPayment  } = (0,_data_order__WEBPACK_IMPORTED_MODULE_14__/* .useOrderPayment */ .fY)();
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        resetCart();
    }, []);
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        createOrderPayment({
            tracking_number: query === null || query === void 0 ? void 0 : query.tracking_number
        });
    }, []);
...
var __webpack_exports__ = __webpack_require__.X(0, [7730,3157,6639,714,518,5517,6524,1932], () => (__webpack_exec__(6973)));
